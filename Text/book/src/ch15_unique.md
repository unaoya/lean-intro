...
- コード: C15_Unique.lean（Proto/Unique → ~90 行）
...
- 線形性・単調性等の ε/2 持ち上げ（v1 対応表）は**発展演習**へ——落ち: **主線（FTC）はこれらを一切使わない**（Ch17 で種明かし）
