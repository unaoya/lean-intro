-- Text/C15_Summit.lean — Ch15 山頂: 連続なら可積分
-- 4 部品分解: (ii) コーシー型判定（本文精読・sup 構成）・(iv) 組み立て（本文完全精読）。
-- (i) 一様連続性は付録 A、(iii) 細分比較は付録 B（statement 精読は本文で）
import Text.A_UnifCont
...
-- ============================================================
-- §1 両側評価の束ね直し（Ch9 の raw 版 → TaggedPartition 版）
-- ============================================================
