...
-- ============================================================
-- §1 代数の小物（my_ring の活躍どころ——Ch10 の道具で短縮する演習）
-- ============================================================
...
-- ============================================================
-- §4 橋の 2 回目: Integral 関数の値として（Ch8 の (n+1)/(2n) と接続して具体例が閉じる）
-- ============================================================
