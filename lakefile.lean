...
-- 本文 7 ファイル（読む順 Intro1a → CH1 → Intro1b → CH2 → Intro2 → Top → Extra）に加えて、
-- ✏ 練習の解答 *Sol も roots に入れてある＝解答も常に Lean に検査される。
lean_lib «LeanIntro» where
  srcDir := "src"
  roots := #[`Intro1a, `CH1, `Intro1b, `CH2, `Intro2, `Top, `Extra,
    `Intro1aSol, `CH1Sol, `Intro1bSol, `CH2Sol, `Intro2Sol, `TopSol, `ExtraSol]
