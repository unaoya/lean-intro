...
> ⚠ **最新確定は構成 v5（2026-06-16・定義先出し/道具先行）**＝第 I 部 Ch1–11／第 II 部 Ch12–16。
> v5 の章立て・設計判断は `docs/textbook_plan.md` の「★ テキスト構成 v5」節を参照。
> **以下 §3 の章別ブリーフは旧構成 v4（第 I 部 Ch0–13／第 II 部 Ch14–18）ベースで、v5 への
> ブリーフ改訂とコード改番は同期して段階実施する**（v4→v5 対応: v4 Ch4-5 定義部→v5 Ch4 統合／
> v4 Ch6-9 道具→v5 Ch5-8／v4 Ch10＋C04/C05 証明部＋Ch13→v5 Ch9 帰納法＋性質／v4 Ch11-12→v5 Ch10-11）。
> 関連（旧 v4）: 本編 第 I 部 Ch0–13／第 II 部 Ch14–18（FTC は Ch18）／発展部 E1–E5／付録 C・D。
