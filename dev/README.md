...
| `08_Real.lean` | 発展演習 — 実数 |
| `09_Ascoli.lean` | 発展演習 — Ascoli の定理 |
| `10_AscoliReal.lean` | 発展演習 — 実数版 Arzelà–Ascoli の定理 |
| `11_Covering.lean` | 発展演習 — グラフの被覆と基本群 |
...
06_Topology・07_Exercises・08_Real・09_Ascoli・10_AscoliReal・11_Covering は通読版にのみ含める。
